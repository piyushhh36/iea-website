...
function uploadGallery(data) {
  ...
  var previewUrl = type === 'video' ? 'https://drive.google.com/file/d/' + fileId + '/preview' : fileUrl;
  ...
  return { success:true, message:'File uploaded', fileUrl:fileUrl, previewUrl:previewUrl };
}
